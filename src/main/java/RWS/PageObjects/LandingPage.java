...
//				Thread.sleep(1000);
				...
				if (!(focusedElement.getAttribute("type") == null)) {
					...
					if (focusedElement.getAttribute("class").contains("autocomplete") && !autoCompleteElementsProcessed.contains(focusedElement.getAttribute("name"))) {
						focusedElement.sendKeys("in");
						Thread.sleep(3000);
						List<WebElement> autoSuggestOptions =driver.findElements(By.cssSelector(".ui-menu.ui-widget.ui-widget-content li"));
